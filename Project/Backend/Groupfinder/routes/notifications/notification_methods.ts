...
/**
 * Manage all interactions with notifications in the database
 */
export class NotificationController {
    /**
     * Returns all notifications belonging to the user with the given ID.
     */
    public getNotifications(userID: number): Promise<Array<Notification>>{
     ...
     */
    public updateStateToSeen(userID: number): Promise<void>{
        return new Promise((resolve: any, reject: any) => {
            const query: string = `
                UPDATE notification
     ...
     */
    public addNotification(notif: Notification): Promise<void>{
        return new Promise((resolve: any, reject: any) => {
            const query: string = `
     ...
     */
    public getNumberOfNewNotifications(userID: number): Promise<number>{
        return new Promise((resolve: any, reject: any) => {
            const query: string = `
