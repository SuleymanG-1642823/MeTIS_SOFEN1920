...
/**
 * Manage all interactions with profile_skill in the database
 */
export class ProfileSkillController {
    /**
     ...
     */
    public getSkillsOfProfile(profileID: number): Promise<Skill[]> {
        return new Promise(
     ...
     */
    public updateSkillOfProfile(profileID: number, skillName: string, skill: Skill): Promise<void> {
        return new Promise(
            (resolve: any, reject: any) => {
     ...
     */
    public removeSkillFromProfile(profileID: number, skillName: string): Promise<void> {
        return new Promise(
            (resolve: any, reject: any) => {
     ...
     */
    public addSkillToProfile(profileID: number, skill: Skill): Promise<void> {
        return new Promise(
            (resolve: any, reject: any) => {
