...
export class ProfileController {
     ...
     */
    public getProjectProfiles(projectID: number): Promise<Profile[]> {
        return new Promise(
            (resolve, reject) => {
     ...
     */
    public updateProfile(profileID: number, profile: Profile): Promise<void> {
        return new Promise(
     ...
     */
    public addProfile(profile: Profile, creator_id: number, project_name: string): Promise<number> {
        return new Promise(
            (resolve: any, reject: any) => {
                console.log("Profile: ");
                console.log(profile);
                ...
                db_conn.query(query, params, async (err: any, rows: any) => {
                    if (err) {
                        ...
                        try{
                            ...
                            const newID: number = await this.getProfileID(profile);
     ...
     */
    public deleteProfile(profileID: number): Promise<void>{
        return new Promise(
            (resolve:any, reject:any) => {
     ...
     */
    public getProfileID(profile: Profile): Promise<number> {
        return new Promise(
            (resolve, reject) => {
