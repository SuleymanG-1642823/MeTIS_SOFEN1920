...
/**
 * Manage all interactions with user_skill in the database
 */
export class UserSkillController {
     ...
     * @param skill_name 
     */
    public updateSkill(userID: number, skill_name: string, newSkill: Skill): Promise<void> {
        return new Promise(
            (resolve, reject) => {
     ...
     */
    public removeSkill(userID: number, skill_name: string): Promise<void> {
        return new Promise(
            (resolve, reject) => {
     ...
     */
    public addSkill(userID: number, skill: Skill): Promise<void> {
        return new Promise(
            (resolve, reject) => {
