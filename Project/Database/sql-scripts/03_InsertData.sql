...
VALUES  ('Back-end developper', 2), ('Front-end developper', 2),
        ('UI/UX designer android', 3), ('Sofware engineer', 3),
        ('UI/UX designer', 1), ('Software engineer windows', 1),
        ('Software engineer linux', 3), ('Software engineer OSX', 3);
